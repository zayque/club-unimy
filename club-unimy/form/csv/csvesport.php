...
header('Content-Disposition: attachment; filename="List Students E-Sports Club.csv"');
...
$query = "SELECT name_user, studentid_user, email_user, phone_user  FROM user WHERE club_user LIKE '%E-Sports%'";
