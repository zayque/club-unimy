...
header('Content-Disposition: attachment; filename="List Students Photography Crew.csv"');
...
$query = "SELECT name_user, studentid_user, email_user, phone_user  FROM user WHERE club_user LIKE '%Photography%'";
