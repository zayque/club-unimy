                ...
                <div id="Approve_Request">
                    <div class="container-form">
                        ...
                        //   $sql = "SELECT * FROM user " . $queryCondition;
                          $sql = "SELECT * FROM user WHERE club_user LIKE '%Music%' " . $queryCondition;
                                ...
                                <div class="card-header">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right mb-4 mr-3">
                                            <a href="print/printmusic.php"><button type="button"
                                                    class="btn btn-secondary text-white">Print</button></a>
                                            <a href="csv/csvmusic.php"><button type="button"
