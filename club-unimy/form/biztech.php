                ...
                <div id="Approve_Request">
                    <div class="container-form">
                        ...
                        //   $sql = "SELECT * FROM user " . $queryCondition;
                          $sql = "SELECT * FROM user WHERE club_user LIKE '%BizTech%' " . $queryCondition;
                        ...
                        ?>
                                <center>
                                    <b>
                                        <p>LIST STUDENTS BizTech Club</p>
                                    </b>
                                </center>
                                <div class="card-header">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right mb-4 mr-3">
                                            <a href="print/printbiztech.php"><button type="button"
                                                    class="btn btn-secondary text-white">Print</button></a>
                                            <a href="csv/csvbiztech.php"><button type="button"
