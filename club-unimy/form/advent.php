            ...
            <div id="dashboard">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" style="color: black">
                        <h4>Adventurous Recreational Club</h4>
                    </li>
                </ol>
                ...
                <div id="Approve_Request">
                    <div class="container-form">
                        ...
                        //   $sql = "SELECT * FROM user " . $queryCondition;
                          $sql = "SELECT * FROM user WHERE club_user LIKE '%Adventurous Recreational%' " . $queryCondition;
                        ...
                        ?>
                                <center>
                                    <b>
                                        <p>LIST STUDENTS Adventurous Recreational Club</p>
                                    </b>
                                </center>
                                <div class="card-header">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right mb-4 mr-3">
                                            <a href="print/printadven.php"><button type="button"
                                                    class="btn btn-secondary text-white">Print</button></a>
                                            <a href="csv/csvadven.php"><button type="button"
