                ...
                <div id="Approve_Request">
                    <div class="container-form">
                        ...
                        //   $sql = "SELECT * FROM user " . $queryCondition;
                          $sql = "SELECT * FROM user WHERE club_user LIKE '%Japananime%' " . $queryCondition;
                        ...
                        ?>
                                <center>
                                    <b>
                                        <p>LIST STUDENTS Japananime Society</p>
                                    </b>
                                </center>
                                <div class="card-header">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right mb-4 mr-3">
                                            <a href="print/printjapan.php"><button type="button"
                                                    class="btn btn-secondary text-white">Print</button></a>
                                            <a href="csv/csvjapan.php"><button type="button"
