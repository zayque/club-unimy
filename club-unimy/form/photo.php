                ...
                <div id="Approve_Request">
                    ...
                    <?php
                        ...
                        //   $sql = "SELECT * FROM user " . $queryCondition;
                          $sql = "SELECT * FROM user WHERE club_user LIKE '%Photography%' " . $queryCondition;
                        ...
                        ?>
                                <center>
                                    <b>
                                        <p>LIST STUDENTS Photography Crew</p>
                                    </b>
                                </center>
                                <div class="card-header">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right mb-4 mr-3">
                                            <a href="print/printphoto.php"><button type="button"
                                                    class="btn btn-secondary text-white">Print</button></a>
                                            <a href="csv/csvphoto.php"><button type="button"
